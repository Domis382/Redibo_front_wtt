...
export default function LoginModal({
  ...
  const handleLogin = async () => {
    ...
    if (password.length < 8 || password.length > 25) {
      setErrorPasswordLength(
        "La cantidad mínima es de 8 caracteres y el máximo es de 25 caracteres."
      );
      setHasLoginError(true);
  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center z-[9999] bg-black/20">
      ...
      >
        ...
        <h1
          className="text-center text-[var(--azul-oscuro)] text-[1.44rem] font-medium leading-normal mb-4"
          style={{
        ...
        >
          Bienvenido a <br />
          <span
            className="text-[var(--naranja)] font-[var(--tamaño-black)] text-[2.488rem]"
            style={{
              fontFamily: "var(--fuente-principal)",
          ...
          <br />
          <span
            className="text-[var(--azul-oscuro)] font-[var(--tamaño-regular)] text-[2.074rem] uppercase"
            style={{
              fontFamily: "var(--fuente-principal)",
              textShadow: "2px 2px 4px rgba(0,0,0,0.4)",
            }}
        ...
        hover:shadow-md"
          >
            ...
            <h4 className="text-[var(--azul-oscuro)] ms-10">Iniciar sesión</h4>
          </button>
        </div>
        {/*borde correo*/}
        <div
          className={`flex shadow-[2px_2px_4px_rgba(0,0,0,0.4)] mt-0 rounded-lg border-2 border-solid ${
            hasLoginError ? "border-[var(--rojo)]" : "border-[var(--negro)]"
          }`}
        >
          {/*icono correo*/}
          <svg
            ...
            fill="currentColor"
            className={`${
              hasLoginError ? "text-[var(--rojo)]" : "text-[var(--azul-oscuro)]"
            } w-[30px] h-[30px] ml-4 mr-0 my-4`}
          >
          ...
          <div className="flex flex-col w-full">
            ...
            <h4
              className={`${
                hasLoginError
                  ? "text-[var(--rojo)]"
                  : "text-[var(--azul-oscuro)]"
              } text-[0.8rem] font-[var(--tamaña-bold)] indent-[1rem] mt-2`}
            ...
            <input
              ...
              className={`w-full h-4 p-4 rounded-lg ${
                hasLoginError
                  ? "text-[var(--rojo)]"
                  : "text-[var(--azul-oscuro)]"
              }`}
        ...
        {errorDomain && (
          <p className="text-[var(--rojo)] text-center text-[0.8rem] font-[var(--tamaña-bold)] mt-1">
            {errorDomain}
          </p>
        )}
        {errorAtSymbol && (
        ...
        {/*borde contraseña*/}
        <div
          className={`flex shadow-[2px_2px_4px_rgba(0,0,0,0.4)] mt-6 rounded-lg border-2 border-solid ${
            hasLoginError ? "border-[var(--rojo)]" : "border-[var(--negro)]"
          }`}
        >
          {/*icono correo*/}
          ...
          {password ? (
            showPassword ? (
              ...
              >
                ...
                <circle
                  ...
                  cy="12"
                  r="5"
                  className="text-[var(--blanco)]"
                />
                <circle
                  cx="12"
                  cy="12"
                  r="3"
                  className={`text-[var(--azul-oscuro)] ${
                    hasLoginError
                      ? "text-[var(--rojo)]"
                      : "text-[var(--azul-oscuro)]"
                  }`}
            ...
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className={`w-[30px] h-[30px] ml-0 mr-4 my-4 ${
                hasLoginError
                  ? "text-[rgba(248,89,89,0.5)]"
                  : "text-[var(--azul-opaco)]"
        ...
        <h5
          className="text-center text-[var(--azul-oscuro)]"
          style={{ fontFamily: "var(--fuente-principal)" }}
        >
          ...
          <button
            ...
            onMouseOver={(e) =>
              (e.currentTarget.style.color = "var(--naranja)")
            }
            onMouseOut={(e) =>
              (e.currentTarget.style.color = "var(--azul-oscuro)")
            }
